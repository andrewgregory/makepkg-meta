...
=item B<-n>, B<--name>=I<pkgname>

Specify the package name.

=item B<-u>, B<--update>=I<pkgname>
...
=item B<-a>, B<--add-depends>=I<dependency>
...
=item B<-r>, B<--rm-depends>=I<dependency>
...
Create and install a new meta-package:
 ...
 makepkg-meta -n foo --description 'foo meta package' -a bar,baz

Update an installed meta-package with explicit dependencies.

 makepkg-meta -u foo --depends qux
